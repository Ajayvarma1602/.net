...
namespace WebApplicationPractice.Controllers
{
    ...
    {
        private readonly WebApplicationPracticeContext _context;

        public StudentDetailsController(WebApplicationPracticeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentRno,Name,Marks")] StudentDetails studentDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentRno,Name,Marks")] StudentDetails studentDetails)
        {
